...
void Conveyor::update(float deltaTime) {
  DrawRectangle(conveyor.x, conveyor.y, conveyor.width, conveyor.height, GRAY);
  DrawRectangleLines(conveyor.x, conveyor.y, conveyor.width, conveyor.height, DARKGRAY);
